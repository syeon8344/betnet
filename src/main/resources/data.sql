...
(1, 1, '자유롭게 야구 이야기를 나눠볼까요? 야구의 역사와 기본 규칙에 대해 이야기해요.', '야구의 역사와 규칙', 10, 5),
(2, 2, '여기 Team2의 게시물에서는 유명한 야구 선수들의 기록을 살펴볼게요.', '유명 선수 기록', 15, 10),
(3, 3, 'Team3의 게시물에서는 야구 경기에서 사용하는 전략에 대해 이야기해요.', '야구 경기 전략', 5, 2),
(4, 4, 'Team4에서는 야구장에서의 팬 경험을 공유할게요.', '팬 경험 이야기', 8, 4),
(5, 5, '이번엔 Team5에서 MLB의 인기 팀들에 대해 이야기해볼까요?', 'MLB 인기 팀', 20, 8),
(6, 6, 'Team6의 게시물에서는 야구의 기본 기술에 대해 알아보아요.', '야구 기본 기술', 12, 7),
(7, 7, 'Team7에서는 전설적인 야구 경기를 소개할게요.', '전설적인 경기들', 18, 12),
(8, 8, '이번에는 Team8의 게시물에서 각 포지션의 역할에 대해 알아봐요.', '포지션 역할 이야기', 6, 3),
(9, 9, 'Team9에서는 야구 규칙의 변화에 대해 이야기할게요.', '규칙 변화 이야기', 9, 5),
(10, 10, '마지막으로 Team10의 게시물은 야구 팬 문화에 대한 이야기예요.', '야구 팬 문화', 22, 10),
(11, 1, 'Team1의 게시물에서는 최근 야구 경기의 하이라이트를 공유할게요.', '최근 경기 하이라이트', 14, 6),
(12, 2, 'Team2의 게시물에서는 전설적인 투수들에 대한 이야기를 나눠볼게요.', '전설적인 투수들', 25, 15),
(13, 3, 'Team3의 게시물은 야구 연습이 왜 중요한지 이야기해요.', '야구 연습의 중요성', 7, 4),
(14, 4, 'Team4에서는 야구의 글로벌화에 대해 이야기해볼게요.', '야구의 글로벌화', 11, 8),
(15, 5, '이번엔 Team5에서 유명한 훈련 기법을 소개할게요.', '유명한 훈련 기법', 24, 12),
(16, 6, 'Team6의 게시물에서는 팀워크가 왜 중요한지 이야기해요.', '팀워크의 중요성', 13, 9),
(17, 7, 'Team7에서는 야구의 미래와 기술 발전에 대해 이야기해볼게요.', '야구의 미래', 19, 11),
(18, 8, '여기 Team8의 게시물은 여성 야구의 발전에 관한 이야기예요.', '여성 야구의 발전', 8, 5),
(19, 9, 'Team9의 게시물에서는 야구 역사 속의 유명한 순간들을 소개할게요.', '역사적인 순간들', 10, 7),
(20, 10, '마지막으로 Team10의 게시물은 팬들이 사랑하는 야구 스타들에 대한 이야기예요.', '사랑받는 야구 스타들', 26, 14),
(21, 1, 'Team1에서는 야구 경기에서의 타격 기술에 대해 이야기해요.', '타격 기술 이야기', 15, 10),
(22, 2, '이번엔 Team2에서 유명한 야구 팀들의 전통에 대해 알아볼까요?', '유명 팀 전통', 23, 13),
(23, 3, 'Team3의 게시물은 야구에서의 수비 전략에 대해 다룹니다.', '수비 전략', 9, 6),
(24, 4, 'Team4의 게시물에서는 야구의 역사적인 경기들을 회상해요.', '역사적인 경기 회상', 12, 8),
(25, 5, 'Team5에서는 야구의 훈련 방법에 대해 자세히 이야기해볼게요.', '야구 훈련 방법', 27, 15),
(26, 6, 'Team6의 게시물은 야구에서의 스포트라이트 선수에 대해 이야기해요.', '스포트라이트 선수', 16, 11),
(27, 7, 'Team7의 게시물에서는 야구에서의 경기 규칙에 대해 알아봅니다.', '경기 규칙 이해하기', 21, 14),
(28, 8, '이번엔 Team8에서 각 팀의 팬 문화에 대해 이야기해요.', '팀 팬 문화', 11, 7),
(29, 9, 'Team9의 게시물은 야구에서의 고전적인 경기 기록을 다뤄요.', '고전적인 경기 기록', 13, 9),
(30, 10, 'Team10에서는 야구의 미래 기술에 대해 예측해볼게요.', '야구의 미래 기술', 28, 16),
(31, 1, 'Team1에서는 야구 팬들이 좋아하는 선수들에 대해 이야기해요.', '팬들이 좋아하는 선수들', 18, 12),
(32, 2, 'Team2의 게시물은 야구 경기 중의 재미있는 에피소드에 대해 이야기해요.', '재미있는 경기 에피소드', 24, 17),
(33, 3, 'Team3에서는 야구의 기본 규칙을 다시 한번 짚어볼게요.', '야구 기본 규칙', 10, 8),
(34, 4, 'Team4의 게시물에서는 중요한 야구 대회에 대해 다룹니다.', '중요한 야구 대회', 14, 10),
(35, 5, 'Team5의 게시물은 유명한 야구 감독들에 대한 이야기예요.', '유명한 야구 감독들', 29, 18),
(36, 6, 'Team6의 게시물에서는 야구에서의 신체적 준비의 중요성을 이야기해요.', '신체적 준비의 중요성', 20, 13),
(37, 7, 'Team7의 게시물은 야구 경기에서의 팬의 역할에 대해 이야기해요.', '팬의 역할', 24, 20),
(38, 8, '이번엔 Team8의 게시물에서 야구에서의 승리의 비결을 알아볼게요.', '승리의 비결', 12, 9),
(39, 9, 'Team9의 게시물에서는 야구에서의 대인 관계에 대해 다뤄요.', '대인 관계의 중요성', 17, 12),
(40, 10, '마지막으로 Team10의 게시물은 최근 경기에서의 인상 깊은 순간들을 공유해요.', '인상 깊은 순간들', 32, 22),
(41, 1, 'Team1의 게시물에서는 야구 선수들의 훈련 일상을 들려줘요.', '선수들의 훈련 일상', 22, 14),
(42, 2, 'Team2의 게시물은 각국의 야구 리그에 대해 이야기해요.', '각국의 야구 리그', 26, 18),
(43, 3, 'Team3의 게시물에서는 야구에서의 심판의 역할에 대해 이야기해요.', '심판의 역할', 14, 10),
(44, 4, 'Team4의 게시물은 야구에서의 스포츠맨십에 대해 다루고 있어요.', '스포츠맨십 이야기', 17, 12),
(45, 5, 'Team5에서는 야구의 다양한 경기 형식에 대해 설명할게요.', '다양한 경기 형식', 32, 22),
(46, 6, 'Team6의 게시물은 야구에서의 팀 전략에 대해 이야기해요.', '팀 전략 이야기', 24, 16),
(47, 7, 'Team7에서는 야구 팬들 사이의 우정에 대해 이야기해요.', '팬들 사이의 우정', 28, 20),
(48, 8, '이번엔 Team8의 게시물에서 야구의 각 포지션의 중요성에 대해 알아봐요.', '포지션의 중요성', 16, 12),
(49, 9, 'Team9의 게시물은 야구 역사 속의 전환점에 대해 이야기해요.', '전환점 이야기', 19, 14),
(50, 10, '키움의 다양한 전술에 대해 알아봐요.', '다양한 전술', 35, 25);
...
-- 굿즈거래 게시판 테이블 샘플
insert into market (mktitle, mkwriter, mkview, mkcontent, mkstate) values
('게시글 제목 1', 2, 0, '게시글 내용 1입니다.', 0),
('게시글 제목 2', 3, 0, '게시글 내용 2입니다.', 0),
('게시글 제목 3', 4, 0, '게시글 내용 3입니다.', 0),
('게시글 제목 4', 5, 0, '게시글 내용 4입니다.', 0),
('게시글 제목 5', 6, 0, '게시글 내용 5입니다.', 0),
('게시글 제목 6', 7, 0, '게시글 내용 6입니다.', 0),
('게시글 제목 7', 8, 0, '게시글 내용 7입니다.', 0),
('게시글 제목 8', 9, 0, '게시글 내용 8입니다.', 0),
('게시글 제목 9', 10, 0, '게시글 내용 9입니다.', 0),
('게시글 제목 10', 11, 0, '게시글 내용 10입니다.', 0),
('게시글 제목 11', 12, 0, '게시글 내용 11입니다.', 0),
('게시글 제목 12', 13, 0, '게시글 내용 12입니다.', 0),
('게시글 제목 13', 14, 0, '게시글 내용 13입니다.', 0),
('게시글 제목 14', 15, 0, '게시글 내용 14입니다.', 0),
('게시글 제목 15', 16, 0, '게시글 내용 15입니다.', 0),
('게시글 제목 16', 17, 0, '게시글 내용 16입니다.', 0),
('게시글 제목 17', 18, 0, '게시글 내용 17입니다.', 0),
('게시글 제목 18', 19, 0, '게시글 내용 18입니다.', 0),
('게시글 제목 19', 20, 0, '게시글 내용 19입니다.', 0),
('게시글 제목 20', 21, 0, '게시글 내용 20입니다.', 0),
('게시글 제목 21', 22, 0, '게시글 내용 21입니다.', 1),
('게시글 제목 22', 23, 0, '게시글 내용 22입니다.', 1),
('게시글 제목 23', 24, 0, '게시글 내용 23입니다.', 0),
('게시글 제목 24', 25, 0, '게시글 내용 24입니다.', 0),
('게시글 제목 25', 26, 0, '게시글 내용 25입니다.', 1),
('게시글 제목 26', 27, 0, '게시글 내용 26입니다.', 0),
('게시글 제목 27', 28, 0, '게시글 내용 27입니다.', 1),
('게시글 제목 28', 29, 0, '게시글 내용 28입니다.', 0),
('게시글 제목 29', 30, 0, '게시글 내용 29입니다.', 1),
('게시글 제목 30', 31, 0, '게시글 내용 30입니다.', 0),
('게시글 제목 31', 32, 0, '게시글 내용 31입니다.', 1),
('게시글 제목 32', 33, 0, '게시글 내용 32입니다.', 1),
('게시글 제목 33', 34, 0, '게시글 내용 33입니다.', 0),
('게시글 제목 34', 35, 0, '게시글 내용 34입니다.', 1),
('게시글 제목 35', 36, 0, '게시글 내용 35입니다.', 0),
('게시글 제목 36', 37, 0, '게시글 내용 36입니다.', 1),
('게시글 제목 37', 38, 0, '게시글 내용 37입니다.', 0),
('게시글 제목 38', 39, 0, '게시글 내용 38입니다.', 1),
('게시글 제목 39', 40, 0, '게시글 내용 39입니다.', 0),
('게시글 제목 40', 41, 0, '게시글 내용 40입니다.', 1),
('게시글 제목 41', 42, 0, '게시글 내용 41입니다.', 0),
('게시글 제목 42', 43, 0, '게시글 내용 42입니다.', 1),
('게시글 제목 43', 44, 0, '게시글 내용 43입니다.', 0),
('게시글 제목 44', 45, 0, '게시글 내용 44입니다.', 1),
('게시글 제목 45', 46, 0, '게시글 내용 45입니다.', 0),
('게시글 제목 46', 47, 0, '게시글 내용 46입니다.', 1),
('게시글 제목 47', 48, 0, '게시글 내용 47입니다.', 0),
('게시글 제목 48', 49, 0, '게시글 내용 48입니다.', 1),
('게시글 제목 49', 50, 0, '게시글 내용 49입니다.', 0),
('게시글 제목 50', 1, 0, '게시글 내용 50입니다.', 1);
